...
SAVE_INTERVAL=500
DATASET_PATH=/code/Megatron-LM/qwen_datasets/wudao_qwenbpe_text_document
VALID_DATASET_PATH=/code/Megatron-LM/qwen_datasets/wudao_qwenbpe_text_document
PRETRAIN_CHECKPOINT_PATH=/model/Aaronzhu/OkapiModel/Qwen2.5/Qwen2_5-7B-Megatron
...
OUTPUT_BASEPATH=/model/Aaronzhu/OkapiModel/Qwen2.5/megatron_output
### OTHERS ###
